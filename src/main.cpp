...
//    його стан (включений або виключений) і багато іншого
//
// Як вийти в меню?
...
//      - Налаштувати статус режима сну
//      - Налаштувати початок сну
//      - Налаштувати кінець сну
//      - Налаштувати відображення секунд
//      - Подивитись заряд батареї
...
//
// Як подивитись час в режимі сну?
//    Для цього натисніть на кнопку SET, і екран покаже вам 
//    час на момент включення протягом 10 секунд, після чого годинник знову засне.
// 
// 
// ----------------------------
